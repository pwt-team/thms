...
$.tzUpload = function(options){
	...
	var settings = {
		flash_url : getRootPath()+"/js/upload/swfupload.swf",//指明文件上传的flash文件
		flash9_url : getRootPath()+"/js/upload/swfupload_fp9.swf",//新版的flash文件
...
$.tzUpload.defaults = {
	...
	single:false,
	htmlbox:"",
	img:getRootPath()+"/js/upload/imagebtn.png",
	reload:function(){
